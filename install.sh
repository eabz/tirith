...
# GitHub release, so the URL above stays stable across releases. Set
...
if [ "$version" = "latest" ]; then
  url="https://github.com/${repo}/releases/latest/download/tirith-installer.sh"
else
  url="https://github.com/${repo}/releases/download/${version}/tirith-installer.sh"
fi
